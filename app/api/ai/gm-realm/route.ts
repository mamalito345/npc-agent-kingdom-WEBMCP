    ...
    const decision =
      ...
      >({
        ...
        system:
          ...
          "TERRAIN REFERENCE: open plains favor cavalry and cavalry_flank tactics; dense forest, mountains and marsh block cavalry flanking and favor infantry holding ground; narrow passes and bridges favor a small defender with shield_wall against a larger attacker; hills and high ground give the defender a real combat bonus. This is not just prose: worldSnapshot.settlements[] and worldSnapshot.armies[] each carry real terrain/terrainDefenseTier/terrainDefenseModifier (or positionTerrain* for armies) fields -- read the actual modifier (0/+1/+2) for a specific node before choosing where to fight or where to march, across every realm you control. " +
